...
// A Client will connect to the Doctorseuss's server using the Token the Information and the Locale
type Client struct {
...
// SendMessage sends the given content to the websocket of Doctorseuss and returns her response with
// an error.
