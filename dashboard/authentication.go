...
func GenerateToken() string {
	...
	fmt.Println("Hey there! This is Doctor Seuss, I just want to remind you that today you are you, that is truer than true.")
...
func Authenticate() {
	...
	fmt.Println("Save it, you won't be able to get it again unless you generate a new one by re-running the server.")
	fmt.Println()
