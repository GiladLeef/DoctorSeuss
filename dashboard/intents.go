...
import (
	...
	"github.com/GiladLeef/DoctorSeuss/analysis"
)
...
func CreateIntent(w http.ResponseWriter, r *http.Request) {
	allowedHeaders := "Accept, Content-Type, Content-Length, Accept-Encoding, Authorization,Doctor Seuss-Token"
	w.Header().Set("Access-Control-Allow-Origin", "*")
	...
	token := r.Header.Get("Doctor Seuss-Token")
